...
class InsertViewModel(var context: Context, var productType: ProductType) : ViewModel() {
    ...
    lateinit var imageCount: MutableLiveData<Int>
    lateinit var imageUrls: MutableLiveData<ArrayList<String>>
    lateinit var isLoading: MutableLiveData<Boolean>


    @RequiresApi(Build.VERSION_CODES.LOLLIPOP)
    var checkNetworkReceiver = CheckNetworkReceiver(context)
    ...
    fun init() {
        ...
        imageUrls = MutableLiveData<ArrayList<String>>()
    ...
    fun addNationalFood(name : String, description: String, price: Double): Boolean {
