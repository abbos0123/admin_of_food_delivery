...
class DeleteAdapter(var list: List<Any>,
    var pagePosition: Int,
    var onDeleteItemClick: OnDeleteItemClick
) :
    RecyclerView.Adapter<DeleteAdapter.UpdateViewHolder>() {
    ...
    inner class UpdateViewHolder(var binding: ItemDeleteBinding) :
        ...
        fun onBind(nationalFood: NationalFood, position: Int) {
            ...
            binding.root0.setOnClickListener {
                onDeleteItemClick.onDeleteItemClick(nationalFood, pagePosition, position)
            }
        ...
        fun onBind(fastFood: FastFood, position: Int) {
            ...
            binding.root0.setOnClickListener {
                onDeleteItemClick.onDeleteItemClick(fastFood, pagePosition, position)
            }
        }
        ...
        fun onBind(dessert: Dessert, position: Int) {
            ...
            binding.root0.setOnClickListener {
                onDeleteItemClick.onDeleteItemClick(dessert, pagePosition, position)
            }
        }
        ...
        fun onBind(snack: Snack, position: Int) {
            ...
            binding.root0.setOnClickListener {
                onDeleteItemClick.onDeleteItemClick(snack, pagePosition, position)
            }
        }
        ...
        fun onBind(beverage: Beverage, position: Int) {
            ...
            binding.root0.setOnClickListener {
                onDeleteItemClick.onDeleteItemClick(beverage, pagePosition, position)
            }
        }
    }
    ...
    interface OnDeleteItemClick {
        fun onDeleteItemClick(myObject: Any, position: Int, positionOwn: Int)
    }
}